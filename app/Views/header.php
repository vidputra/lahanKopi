                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('dist/img/dimas.png') ?>" class="user-image" alt=" User Image">
                                <span class="hidden-xs">Dimas Fadhillah</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="<?php echo base_url('dist/img/dimas.png') ?>" class=" img-circle" alt="User Image">

                                    <p>
                                        Dimas Fadhillah - Mahasiswa
                                        <small>Coffe Hunter</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview menu-open">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?= base_url('Login/AdminView') ?>"><i class="fa fa-circle-o"></i> Data Admin</a></li>
